...
1. レビューの価値向上
レビューの入手方法を、位置情報を利用したユーザー同士の「すれ違い」という偶然性の高い手段に限定しました。これにより、レビューの入手機会が制限され、一つ一つの情報の希少価値が高まります。また、他者と共有できるレビューも自身のストックから1つに絞る方式とし、ユーザーがより価値が高いと判断した情報を厳選して共有するよう動機付けます。
