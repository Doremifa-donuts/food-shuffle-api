...
type Review struct {
	...
	ReviewImages            StringArray               `gorm:"type:json;not null"`                      // レビューに関連する画像のパスをJSONで保存する
...
var sampleReviews = []Review{
	{
		...
		ReviewImages:   StringArray{"92319be6-48e1-485a-9eaf-8c7b6af0f789", "27922620-d0b6-4fbe-b76f-35521b1cb851", "a5c7632f-a3e0-410a-9d73-75cc6646ad42"},
